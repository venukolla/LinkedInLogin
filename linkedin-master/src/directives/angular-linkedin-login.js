                    ...
                    compile: function (tElem, tAttrs) {
                        ...
                        if(!linkedinLibLoaded){
                            ...
                            $.getScript("//platform.linkedin.com/in.js?async=true", function success() {
                                IN.init({
                                    ...
                                    api_key: "75i1jzs7we57mk",
                                    credentials_cookie: true, scope: 'r_fullprofile r_contactinfo'
                                });
                            });
                        ...
                        return function (scope, elem, attrs) {
                            ...
                            var linkedinAuthorized = function(){
                                if(_profileDataHandler && typeof _profileDataHandler == 'function'){
                                    IN.API.Profile("me")
                                        .fields('id', 'first-name', 'last-name', 'location', 'industry', 'headline', 'picture-urls::(original)', 'email-address', 'skills', 'date-of-birth','phone-numbers')
